...
__doc__='''HttpsMonitorDataSource.py

Defines datasource for HttpsMonitor
'''
...
class HttpsMonitorDataSource(ZenPackPersistence, RRDDataSource.RRDDataSource):
    
    HTTPS_MONITOR = 'HttpsMonitor'
    
    ZENPACKID = 'ZenPacks.zenoss.HttpsMonitor'
    
    sourcetypes = (HTTPS_MONITOR,)
    sourcetype = HTTPS_MONITOR
    ...
    { 
        'immediate_view' : 'editHttpsMonitorDataSource',
        'actions'        :
        ( 
            { 'id'            : 'edit',
              'name'          : 'Data Source',
              'action'        : 'editHttpsMonitorDataSource',
    ...
    def getDescription(self):
        if self.sourcetype == self.HTTPS_MONITOR:
